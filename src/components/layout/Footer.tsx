        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex gap-3">
              <a
                href="#"
                className="w-9 h-9 rounded-lg border border-white/10 hover:border-purple-500/50 flex items-center justify-center transition-all hover:bg-purple-500/10 text-white/50 hover:text-purple-400"
                aria-label="LinkedIn"
              >
                <LinkedInIcon />
              </a>
        ...
        <div className="border-t border-white/5 mt-12 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex gap-6">
            {["Privacy Policy", "Terms of Service", "GDPR"].map((item) => (
              <span
                key={item}
                className="text-white/20 text-sm cursor-default"
              >
                {item}
              </span>
            ))}
